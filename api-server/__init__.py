...
def create_app(test_config=None):
    ...
    def inputImageName(imageName):
        return app.config['IMAGE_INPUT'] + imageName + '.jpg'
    ...
    def depth():
        ...
        if not os.path.isfile(inputImageName(imageName)):
            ...
            if img_data.status_code != 200:
                ...
                abort(404)
            with open(inputImageName(imageName), 'wb') as handler:
            ...
            # os.remove(inputImageName(imageName))
